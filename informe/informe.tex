...
\begin{center}
% \includegraphics[scale=0.35]{controller_logs_80.png}
\end{center}
...
\subsubsection{Wireshark}
\begin{center}
% \includegraphics[scale=0.35]{wireshark_no_comm.png}
\end{center}

\subsubsection{Logs del controlador}
\begin{center}
% \includegraphics[scale=0.35]{controller_logs_no_comm.png}
\end{center}
